...
# === Percorsi ai file ===
files = {
    "ICP": "icp_noFilter_results/icp_no_filter_summary.txt",
    "ICP PointToPoint":"icp_point_to_point_noFilter_results/icp_point_to_point_summary.txt",
}
...
plt.grid(True)
plt.tight_layout()
plt.savefig("boxplot_fitness_esterno.png", dpi=300)
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("boxplot_rmse_esterno.png", dpi=300)
plt.show()